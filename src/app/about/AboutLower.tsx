...
const AboutLower = () => {
  ...
  return (
    <div className='ABOUTLOWER bg-black relative flex px-4 w-screen h-[50vh] mt-[0vh] z-10'>
      {/* <Image alt='' src={img}  className=' lg:h-full w-auto mx-auto'/> */}
      <div className='aboutUsLowerContent relative max-w-[400px] text-slate-400 text-justify mx-auto mt-20 md:mt-4'>
